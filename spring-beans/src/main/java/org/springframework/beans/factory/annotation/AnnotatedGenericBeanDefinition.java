...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	...
	public AnnotatedGenericBeanDefinition(Class<?> beanClass) {
		...
		/**
		 ...
		 在创建它的时候会通过AnnotationMetadata.introspect(beanClass)拿到这个类上面的元信息（元信息是包括他的类信息，注解信息，接口信息，字段信息等等）。
		 @see org.springframework.core.type.StandardAnnotationMetadata#StandardAnnotationMetadata
		 @see org.springframework.core.annotation.TypeMappedAnnotations#from(AnnotatedElement, MergedAnnotations.SearchStrategy, RepeatableContainers) 
		 */
